...
# Dumps the hf table into a format suitable for comparison with the normalized
# form generated by HathifilesDatabase::DB::Connection#dump_from_file
module HathifilesDatabase
  class Dumper
    ...
    # Create a database dump based on a hathifile without
